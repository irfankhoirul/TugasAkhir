...
public class Activity4c_ShowPothole extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//        Toast.makeText(getBaseContext(), start+" - "+end, Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.filterQuery) {
            Intent i = new Intent(Activity4c_ShowPothole.this, Activity6b_App1ResultFilter.class);
            startActivity(i);
            return(true);
        }
        else if (id == R.id.hasilKhusus) {
            Intent i = new Intent(Activity4c_ShowPothole.this, Activity6c_App1SpecialResult.class);
            startActivity(i);
            return(true);
        }
    ...
    public void onBackPressed()
    {
        ...
        Intent intent = new Intent(Activity4c_ShowPothole.this, Activity2_MainMap.class);
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(Activity4c_ShowPothole.this);
        ...
        protected void onPostExecute(Boolean th){
            ...
            if(th == true){
                ...
                SnackbarManager.show(
                        Snackbar.with(Activity4c_ShowPothole.this)
                                .text("Koneksi Gagal!")
    ...
    private class LoadingResultData extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Activity4c_ShowPothole.this);
