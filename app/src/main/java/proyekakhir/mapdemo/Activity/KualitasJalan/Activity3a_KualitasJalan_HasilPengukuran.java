...
//    List<Integer> tT = new ArrayList<>(); //waktu
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(Activity3a_KualitasJalan_HasilPengukuran.this, Activity3b_KualitasJalan_HasilPengukuran_Preview.class);
    ...
    public void onBackPressed()
    {
        ...
        Intent intent = new Intent(Activity3a_KualitasJalan_HasilPengukuran.this, Activity2_MainMap.class);
        startActivity(intent);
        finish();
    }
...
*/
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(Activity3a_KualitasJalan_HasilPengukuran.this);
    ...
    private class CompletingData extends AsyncTask<String, String, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Activity3a_KualitasJalan_HasilPengukuran.this);
    ...
    private class SendData extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Activity3a_KualitasJalan_HasilPengukuran.this);
            pDialog.setTitle("Mengontak Server");
