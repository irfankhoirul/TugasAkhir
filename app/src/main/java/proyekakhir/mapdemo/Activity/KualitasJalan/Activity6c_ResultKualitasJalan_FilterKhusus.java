...
public class Activity6c_ResultKualitasJalan_FilterKhusus extends AppCompatActivity {
...
//    List<String> FILTER_KUALITAS = new ArrayList<String>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //        Toast.makeText(getBaseContext(), "Tanggal : "+filter6, Toast.LENGTH_LONG).show();
                ...
                if(where.equals("") && filter6.equals("")){
                    ...
                    if(where.equals(""))
                        where = "1";
                    Intent intent = new Intent(Activity6c_ResultKualitasJalan_FilterKhusus.this, Activity6_ResultKualitasJalan.class);
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(Activity6c_ResultKualitasJalan_FilterKhusus.this);
        ...
        protected void onPostExecute(Boolean th){
            ...
            if(th){
                ...
                SnackbarManager.show(
                        Snackbar.with(Activity6c_ResultKualitasJalan_FilterKhusus.this)
                                .text("Koneksi Gagal!")
                        ...
                        , Activity6c_ResultKualitasJalan_FilterKhusus.this);
            }
        }
    }
    ...
    private class LoadFilter extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Activity6c_ResultKualitasJalan_FilterKhusus.this);
