...
public class Activity6b_ResultKualitasJalan_FilterUmum extends AppCompatActivity {
    ...
    List<String> FILTER_NAMA_JALAN = new ArrayList<>();
    List<String> FILTER_KECAMATAN = new ArrayList<>();
    List<String> FILTER_KOTA = new ArrayList<>();
    List<String> FILTER_PROVINSI = new ArrayList<>();
    List<String> FILTER_KUALITAS = new ArrayList<>();
        ...
        */
        ...
        actResultFilter_bt_show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!where.equals("")) {
                    Intent intent = new Intent(Activity6b_ResultKualitasJalan_FilterUmum.this, Activity6_ResultKualitasJalan.class);
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(Activity6b_ResultKualitasJalan_FilterUmum.this);
        ...
        protected void onPostExecute(Boolean th){
            ...
            //    Toast.makeText(getBaseContext(), "Error in Network Connection", Toast.LENGTH_SHORT).show();
                SnackbarManager.show(
                        Snackbar.with(Activity6b_ResultKualitasJalan_FilterUmum.this)
                                .text("Koneksi Gagal!")
                        ...
                        , Activity6b_ResultKualitasJalan_FilterUmum.this);
            }
        }
    }
    ...
    private class LoadFilter extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Activity6b_ResultKualitasJalan_FilterUmum.this);
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                ...
                //    Log.v("Filter", json.toString());
                    ...
                    adapterKualitas = new ArrayAdapter<>(
                            getApplicationContext(), R.layout.custom_spinner_item,
                            FILTER_KUALITAS);
