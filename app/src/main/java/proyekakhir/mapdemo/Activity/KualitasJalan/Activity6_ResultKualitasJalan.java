...
//        Toast.makeText(getBaseContext(), start+" - "+end, Toast.LENGTH_SHORT).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.filterQuery) {
            Intent i = new Intent(Activity6_ResultKualitasJalan.this, Activity6b_ResultKualitasJalan_FilterUmum.class);
            startActivity(i);
            finish();
            return(true);
        }
        else if (id == R.id.hasilKhusus) {
            Intent i = new Intent(Activity6_ResultKualitasJalan.this, Activity6c_ResultKualitasJalan_FilterKhusus.class);
            startActivity(i);
            finish();
            return(true);
        }
            ...
            if(!max) {
                Intent i = new Intent(Activity6_ResultKualitasJalan.this, Activity6_ResultKualitasJalan.class);
    ...
    public void onBackPressed()
    {
        ...
        Intent intent = new Intent(Activity6_ResultKualitasJalan.this, Activity2_MainMap.class);
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(Activity6_ResultKualitasJalan.this);
        ...
        protected void onPostExecute(Boolean th){
            ...
            //    Toast.makeText(getBaseContext(), "Error in Network Connection", Toast.LENGTH_SHORT).show();
                SnackbarManager.show(
                        Snackbar.with(Activity6_ResultKualitasJalan.this)
                                .text("Koneksi Gagal!")
                        ...
                        , Activity6_ResultKualitasJalan.this);
            }
        }
    }
    ...
    private class LoadingResultData extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Activity6_ResultKualitasJalan.this);
