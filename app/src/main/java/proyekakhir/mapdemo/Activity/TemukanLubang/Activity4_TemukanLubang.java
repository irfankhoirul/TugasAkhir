...
public class Activity4_TemukanLubang extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    private double tempSpeed, tempAccuracy;
...
//    List<Double> speed = new ArrayList<>();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pgDialog = new ProgressDialog(Activity4_TemukanLubang.this);
        okDialog = new ProgressDialog(Activity4_TemukanLubang.this);
    ...
    private void setUpMap() {
        ...
        GoogleMap.OnMyLocationChangeListener myLocationChangeListener = new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                ...
                //    Log.v("Cek Satu",
                //                    Double.toString(tempSpeed)+"\n"+
                //                    Double.toString(tempAccuracy)+"\n"+
                //                    Integer.toString(count)); //Cek interval
...
//        saveData();
        ...
        if(lat.length > 0 ) {
            Intent i = new Intent(Activity4_TemukanLubang.this, Activity4a_TemukanLubang_HasilPengukuran.class);
            ...
            Intent intent = new Intent(Activity4_TemukanLubang.this, Activity2_MainMap.class);
...
//            File myFile = new File("/sdcard/pengukuran/p"+countPengukuran+".txt");
    ...
    private class NetCheck extends AsyncTask<String,String,Boolean>
    {
        ...
        protected void onPreExecute(){
            super.onPreExecute();
            nDialog = new ProgressDialog(Activity4_TemukanLubang.this);
        ...
        protected void onPostExecute(Boolean th){
            ...
            if(th){
                nDialog.dismiss();
                koneksi = true;
                pDialog = new ProgressDialog(Activity4_TemukanLubang.this);
