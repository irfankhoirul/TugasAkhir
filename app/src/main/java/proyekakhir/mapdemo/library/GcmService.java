...
import proyekakhir.mapdemo.Activity6d_PotholeDetails;
...
//        logger = new LoggingService.Logger(this);
    ...
    //    sendNotification("Received: " + data.toString());
        ...
        Intent resultIntent = new Intent(this, Activity6d_PotholeDetails.class);
        ...
        stackBuilder.addParentStack(Activity6d_PotholeDetails.class);
